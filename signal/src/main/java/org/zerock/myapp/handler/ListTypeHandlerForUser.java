...
import org.zerock.myapp.domain.ProfileDTO;

public class ListTypeHandlerForUser extends BaseTypeHandler<List<ProfileDTO>>  {


	    @Override
	    public void setNonNullParameter(PreparedStatement ps, int i, List<ProfileDTO> parameter, JdbcType jdbcType) throws SQLException {
	    ...
	    @Override
	    public List<ProfileDTO> getNullableResult(ResultSet rs, String columnName) throws SQLException {
	    ...
	    @Override
	    public List<ProfileDTO> getNullableResult(ResultSet rs, int columnIndex) throws SQLException {
	    ...
	    @Override
	    public List<ProfileDTO> getNullableResult(CallableStatement cs, int columnIndex) throws SQLException {
