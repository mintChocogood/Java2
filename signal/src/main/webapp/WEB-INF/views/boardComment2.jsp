	...
	<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
		...
		<body>
			...
			<div class="reply_wrap">
				<div class="reply_title" id="reply_list">
					<i class="fas fa-comment-dots"></i>&nbsp;<i
						style="color: orangered;">${__commentPage__.commentTotalAmount}</i>&nbsp;댓글
				</div>
					...
					$('.pageNum')
						.on(
							...
							function (e) {
								...
								location = "/board/group/get?currPage=${param.currPage}&postNo=${__BOARD__.postNo}&commentCurrPage="
									+ selectedPageNum;
							});
				});
				...
				$(function () {
					$('.replyWriteBtn')
						.on(
							'click',
							function () {
								location = "/board/group/get?currPage=${param.currPage}&postNo=${__BOARD__.postNo}&commentCurrPage=" + 1;
							});
				});
				$(function () {
